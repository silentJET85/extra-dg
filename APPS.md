## Apps available in this repository:

<br>

| Package Name | Install Source | Description |
| --- | --- | --- |
| [`brave-browser-beta`](https://brave.com/) | Apt Repo | Browse privately. Search privately. And ditch Big Tech. |
| [`brave-browser-nightly`](https://brave.com/) | Apt Repo | Browse privately. Search privately. And ditch Big Tech. |
| [`codium-insiders`](https://vscodium.com/) | Github | A community-driven, freely-licensed binary distribution of Microsoft’s editor VS Code Insiders |
| [`freetube`](https://freetubeapp.io/) | Github | An Open Source YouTube app for privacy |
